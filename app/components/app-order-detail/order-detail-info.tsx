    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <div className="rounded-lg border p-6">
        <div className="grid grid-cols-7 gap-4">
          ...
          <div className="space-y-2">
            <div className="text-sm font-medium">発注日</div>
            <div>2025/03/14</div>
          </div>
        ...
        <CollapsibleContent>
          <div className="grid grid-cols-7 gap-4 pt-4">
            ...
            <div className="space-y-2 col-span-2">
              <div className="text-sm font-medium">仕入先</div>
              <div>053016 ﾀﾞｲﾜﾎﾞｳ情報ｼｽﾃﾑ㈱</div>
            </div>

            <div className="space-y-2 col-start-1">
              <div className="text-sm font-medium">仕入形態</div>
              <div>取次</div>
            </div>

            <div className="space-y-2 col-span-2">
              <div className="text-sm font-medium">得意先</div>
              <div>010001 スワテック建設</div>
            </div>

            <div className="space-y-2 col-span-2">
              <div className="text-sm font-medium">現場</div>
              <div>000003 土木部</div>
            </div>
          </div>
        </CollapsibleContent>
